...
public class TC_WebDemo extends AbstractTest {
    ...
    String fisrtGood = "Santoni - Blog & Magazine Elementor Template Kit";
    ...
    public void TC_02_Test() {
        ...
        checkOutPage.verifyTextElement(CheckOutPageUI.GOOD_TEXT_BY_NAME, "Santoni", fisrtGood);
        ...
        checkOutPage.verifyTextMoney(CheckOutPageUI.GOOD_TEXT_BY_MONEY, "49", "$49");
        ...
        checkOutPage.verifyCartTotal(CheckOutPageUI.CART_TOTAL, "68");
